...
pub fn number_to_words(n: i64) -> String {
    ...
    if n >= 1_000_000_000_000_000 {
        ...
        return format!("{}{}{}", quadrillion_text, connector, number_to_words(remainder));
    }
    ...
    if n >= 1_000_000_000_000 {
        ...
        let connector = if remainder < 100 { " e " } else { ", " };
        return format!("{}{}{}", trillion_text, connector, number_to_words(remainder));
    }
    ...
    if n >= 1_000_000_000 {
        ...
        let connector = if remainder < 100 { " e " } else { ", " };
        return format!("{}{}{}", billion_text, connector, number_to_words(remainder));
    }
    ...
    if n >= 1_000_000 {
        ...
        let connector = if remainder < 100 { " e " } else { ", " };
        return format!("{}{}{}", million_text, connector, number_to_words(remainder));
    }
    ...
    if n >= 1000 {
        ...
        let connector = if remainder % 100 == 0 || remainder < 100 { " e " } else { ", " };
        return format!("{}{}{}", thousand_text, connector, number_to_words(remainder));
    }
...
pub fn convert_real_to_text(value: f64) -> String {
    ...
    if centavos > 0 {
        ...
        let centavo_text = if centavos == 1 {
            "centavo"
        } else {
            "centavos"
        };
...
mod tests {
    ...
    fn test_format_currency_rounding() {
        ...
        assert_eq!(
            format_currency(10.555),
            Some("R$ 10,56".to_string())
        );
    }
    ...
    fn test_convert_real_to_text_with_cents() {
        ...
        assert_eq!(convert_real_to_text(2.50), "dois reais e cinquenta centavos");
        assert_eq!(convert_real_to_text(10.99), "dez reais e noventa e nove centavos");
    }
    ...
    fn test_convert_real_to_text_large_values() {
        ...
        assert_eq!(convert_real_to_text(1000000.50), "um milhão de reais e cinquenta centavos");
    }

    #[test]
    fn test_convert_real_to_text_negative() {
        assert_eq!(convert_real_to_text(-1.0), "menos um real");
        assert_eq!(convert_real_to_text(-2.50), "menos dois reais e cinquenta centavos");
        assert_eq!(convert_real_to_text(-100.0), "menos cem reais");
    }

    #[test]
    fn test_convert_real_to_text_complex() {
        assert_eq!(convert_real_to_text(1111.11), "mil, cento e onze reais e onze centavos");
