...
fn main() {
    ...
    println!(
        "   01/01/2024 (Ano Novo): {}",
        if is_holiday(new_year, None).unwrap() {
            "FERIADO"
        } else {
            "Dia comum"
        }
    ...
    println!(
        ...
        if is_holiday(tiradentes, None).unwrap() {
            "FERIADO"
        } else {
            "Dia comum"
        }
    ...
    println!(
        ...
        if is_holiday(labor_day, None).unwrap() {
            "FERIADO"
        } else {
            "Dia comum"
        }
    ...
    println!(
        ...
        if is_holiday(good_friday, None).unwrap() {
            "FERIADO"
        } else {
            "Dia comum"
        }
    ...
    println!(
        ...
        if is_holiday(independence, None).unwrap() {
            "FERIADO"
        } else {
            "Dia comum"
        }
    ...
    println!(
        "   25/12/2024 (Natal): {}",
        if is_holiday(christmas, None).unwrap() {
            "FERIADO"
        } else {
            "Dia comum"
        }
    ...
    println!(
        ...
        if is_holiday(regular_day, None).unwrap() {
            "FERIADO"
        } else {
            "Dia comum"
        }
    ...
    println!(
        "     - Na Bahia (BA): {}",
        if is_holiday(bahia_independence, Some("BA")).unwrap() {
            "FERIADO"
        } else {
            "Dia comum"
        }
    ...
    println!(
        "     - Em São Paulo (SP): {}",
        if is_holiday(bahia_independence, Some("SP")).unwrap() {
            "FERIADO"
        } else {
            "Dia comum"
        }
    ...
    println!(
        "     - Em São Paulo (SP): {}",
        if is_holiday(sp_revolution, Some("SP")).unwrap() {
            "FERIADO"
        } else {
            "Dia comum"
        }
    ...
    println!(
        ...
        if is_holiday(sp_revolution, Some("RJ")).unwrap() {
            "FERIADO"
        } else {
            "Dia comum"
        }
    ...
    println!(
        "     - Em Alagoas (AL): {}",
        if is_holiday(black_awareness, Some("AL")).unwrap() {
            "FERIADO"
        } else {
            "Dia comum"
        }
    ...
    println!(
        "     - Em São Paulo (SP): {}",
        if is_holiday(black_awareness, Some("SP")).unwrap() {
            "FERIADO"
        } else {
            "Dia comum"
        }
